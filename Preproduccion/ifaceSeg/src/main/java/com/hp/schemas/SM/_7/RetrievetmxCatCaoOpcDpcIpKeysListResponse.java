/**
 * RetrievetmxCatCaoOpcDpcIpKeysListResponse.java
 *
...
public class RetrievetmxCatCaoOpcDpcIpKeysListResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.TmxCatCaoOpcDpcIpKeysType[] keys;
    ...
    public RetrievetmxCatCaoOpcDpcIpKeysListResponse() {
    }

    public RetrievetmxCatCaoOpcDpcIpKeysListResponse(
           com.hp.schemas.SM._7.TmxCatCaoOpcDpcIpKeysType[] keys,
    ...
    /**
     * Gets the keys value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return keys
     */
    public com.hp.schemas.SM._7.TmxCatCaoOpcDpcIpKeysType[] getKeys() {
        return keys;
    }


    /**
     * Sets the keys value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param keys
     */
    public void setKeys(com.hp.schemas.SM._7.TmxCatCaoOpcDpcIpKeysType[] keys) {
        this.keys = keys;
    }

    public com.hp.schemas.SM._7.TmxCatCaoOpcDpcIpKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.hp.schemas.SM._7.TmxCatCaoOpcDpcIpKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrievetmxCatCaoOpcDpcIpKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrievetmxCatCaoOpcDpcIpKeysListResponse)) return false;
        RetrievetmxCatCaoOpcDpcIpKeysListResponse other = (RetrievetmxCatCaoOpcDpcIpKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrievetmxCatCaoOpcDpcIpKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrievetmxCatCaoOpcDpcIpKeysListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "tmxCatCaoOpcDpcIpKeysType"));
