/**
 * RetrieveSegTmxCaseServEmpExtKeysListResponse.java
 *
...
public class RetrieveSegTmxCaseServEmpExtKeysListResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.SegTmxCaseServEmpExtKeysType[] keys;
    ...
    public RetrieveSegTmxCaseServEmpExtKeysListResponse() {
    }

    public RetrieveSegTmxCaseServEmpExtKeysListResponse(
           com.hp.schemas.SM._7.SegTmxCaseServEmpExtKeysType[] keys,
    ...
    /**
     * Gets the keys value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return keys
     */
    public com.hp.schemas.SM._7.SegTmxCaseServEmpExtKeysType[] getKeys() {
        return keys;
    }


    /**
     * Sets the keys value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param keys
     */
    public void setKeys(com.hp.schemas.SM._7.SegTmxCaseServEmpExtKeysType[] keys) {
        this.keys = keys;
    }

    public com.hp.schemas.SM._7.SegTmxCaseServEmpExtKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.hp.schemas.SM._7.SegTmxCaseServEmpExtKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveSegTmxCaseServEmpExtKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveSegTmxCaseServEmpExtKeysListResponse)) return false;
        RetrieveSegTmxCaseServEmpExtKeysListResponse other = (RetrieveSegTmxCaseServEmpExtKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveSegTmxCaseServEmpExtKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrieveSegTmxCaseServEmpExtKeysListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "SegTmxCaseServEmpExtKeysType"));
