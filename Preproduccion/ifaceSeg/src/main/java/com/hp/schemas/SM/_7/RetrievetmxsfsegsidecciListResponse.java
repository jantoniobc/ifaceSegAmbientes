/**
 * RetrievetmxsfsegsidecciListResponse.java
 *
...
public class RetrievetmxsfsegsidecciListResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.TmxsfsegsidecciInstanceType[] instance;
    ...
    public RetrievetmxsfsegsidecciListResponse() {
    }

    public RetrievetmxsfsegsidecciListResponse(
           com.hp.schemas.SM._7.TmxsfsegsidecciInstanceType[] instance,
    ...
    /**
     * Gets the instance value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return instance
     */
    public com.hp.schemas.SM._7.TmxsfsegsidecciInstanceType[] getInstance() {
        return instance;
    }


    /**
     * Sets the instance value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param instance
     */
    public void setInstance(com.hp.schemas.SM._7.TmxsfsegsidecciInstanceType[] instance) {
        this.instance = instance;
    }

    public com.hp.schemas.SM._7.TmxsfsegsidecciInstanceType getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, com.hp.schemas.SM._7.TmxsfsegsidecciInstanceType _value) {
        this.instance[i] = _value;
    }


    /**
     * Gets the messages value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrievetmxsfsegsidecciListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrievetmxsfsegsidecciListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrievetmxsfsegsidecciListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrievetmxsfsegsidecciListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrievetmxsfsegsidecciListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrievetmxsfsegsidecciListResponse)) return false;
        RetrievetmxsfsegsidecciListResponse other = (RetrievetmxsfsegsidecciListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrievetmxsfsegsidecciListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrievetmxsfsegsidecciListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "tmxsfsegsidecciInstanceType"));
