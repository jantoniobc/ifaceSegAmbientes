/**
 * RetrievetmxCatCaoCentralEqpListResponse.java
 *
...
public class RetrievetmxCatCaoCentralEqpListResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.TmxCatCaoCentralEqpInstanceType[] instance;
    ...
    public RetrievetmxCatCaoCentralEqpListResponse() {
    }

    public RetrievetmxCatCaoCentralEqpListResponse(
           com.hp.schemas.SM._7.TmxCatCaoCentralEqpInstanceType[] instance,
    ...
    /**
     * Gets the instance value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return instance
     */
    public com.hp.schemas.SM._7.TmxCatCaoCentralEqpInstanceType[] getInstance() {
        return instance;
    }


    /**
     * Sets the instance value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param instance
     */
    public void setInstance(com.hp.schemas.SM._7.TmxCatCaoCentralEqpInstanceType[] instance) {
        this.instance = instance;
    }

    public com.hp.schemas.SM._7.TmxCatCaoCentralEqpInstanceType getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, com.hp.schemas.SM._7.TmxCatCaoCentralEqpInstanceType _value) {
        this.instance[i] = _value;
    }


    /**
     * Gets the messages value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrievetmxCatCaoCentralEqpListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrievetmxCatCaoCentralEqpListResponse)) return false;
        RetrievetmxCatCaoCentralEqpListResponse other = (RetrievetmxCatCaoCentralEqpListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrievetmxCatCaoCentralEqpListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrievetmxCatCaoCentralEqpListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "tmxCatCaoCentralEqpInstanceType"));
