/**
 * RetrieveContactosSEGKeysListResponse.java
 *
...
public class RetrieveContactosSEGKeysListResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.ContactosSEGKeysType[] keys;
    ...
    public RetrieveContactosSEGKeysListResponse() {
    }

    public RetrieveContactosSEGKeysListResponse(
           com.hp.schemas.SM._7.ContactosSEGKeysType[] keys,
    ...
    /**
     * Gets the keys value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return keys
     */
    public com.hp.schemas.SM._7.ContactosSEGKeysType[] getKeys() {
        return keys;
    }


    /**
     * Sets the keys value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param keys
     */
    public void setKeys(com.hp.schemas.SM._7.ContactosSEGKeysType[] keys) {
        this.keys = keys;
    }

    public com.hp.schemas.SM._7.ContactosSEGKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.hp.schemas.SM._7.ContactosSEGKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveContactosSEGKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveContactosSEGKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveContactosSEGKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveContactosSEGKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveContactosSEGKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveContactosSEGKeysListResponse)) return false;
        RetrieveContactosSEGKeysListResponse other = (RetrieveContactosSEGKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveContactosSEGKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrieveContactosSEGKeysListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "ContactosSEGKeysType"));
