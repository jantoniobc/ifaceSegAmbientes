/**
 * InfoSidecciEmpresaSmSegInstanceTypeConsultaResultado.java
 *
...
public class InfoSidecciEmpresaSmSegInstanceTypeConsultaResultado  extends com.hp.schemas.SM._7.Common.ArrayType  implements java.io.Serializable {
    private com.hp.schemas.SM._7.Common.StringType[] consultaResultado;

    public InfoSidecciEmpresaSmSegInstanceTypeConsultaResultado() {
    }
    ...
    /**
     * Gets the consultaResultado value for this InfoSidecciEmpresaSmSegInstanceTypeConsultaResultado.
     * 
    ...
    /**
     * Sets the consultaResultado value for this InfoSidecciEmpresaSmSegInstanceTypeConsultaResultado.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InfoSidecciEmpresaSmSegInstanceTypeConsultaResultado)) return false;
        InfoSidecciEmpresaSmSegInstanceTypeConsultaResultado other = (InfoSidecciEmpresaSmSegInstanceTypeConsultaResultado) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InfoSidecciEmpresaSmSegInstanceTypeConsultaResultado.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">infoSidecciEmpresaSmSegInstanceType>consultaResultado"));
