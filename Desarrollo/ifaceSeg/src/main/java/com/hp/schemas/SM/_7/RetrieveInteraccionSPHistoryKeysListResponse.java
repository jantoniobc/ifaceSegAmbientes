/**
 * RetrieveInteraccionSPHistoryKeysListResponse.java
 *
...
public class RetrieveInteraccionSPHistoryKeysListResponse  implements java.io.Serializable {
    ...
    public RetrieveInteraccionSPHistoryKeysListResponse() {
    }
    ...
    /**
     * Gets the keys value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return keys
     */
    ...
    /**
     * Sets the keys value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param keys
     */
    ...
    public com.hp.schemas.SM._7.InteraccionSPHistoryKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.hp.schemas.SM._7.InteraccionSPHistoryKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveInteraccionSPHistoryKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveInteraccionSPHistoryKeysListResponse)) return false;
        RetrieveInteraccionSPHistoryKeysListResponse other = (RetrieveInteraccionSPHistoryKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveInteraccionSPHistoryKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrieveInteraccionSPHistoryKeysListResponse"));
