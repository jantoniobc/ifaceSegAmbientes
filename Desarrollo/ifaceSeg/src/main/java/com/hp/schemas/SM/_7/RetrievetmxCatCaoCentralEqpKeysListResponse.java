/**
 * RetrievetmxCatCaoCentralEqpKeysListResponse.java
 *
...
public class RetrievetmxCatCaoCentralEqpKeysListResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.TmxCatCaoCentralEqpKeysType[] keys;
    ...
    public RetrievetmxCatCaoCentralEqpKeysListResponse() {
    }

    public RetrievetmxCatCaoCentralEqpKeysListResponse(
           com.hp.schemas.SM._7.TmxCatCaoCentralEqpKeysType[] keys,
    ...
    /**
     * Gets the keys value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return keys
     */
    public com.hp.schemas.SM._7.TmxCatCaoCentralEqpKeysType[] getKeys() {
        return keys;
    }


    /**
     * Sets the keys value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param keys
     */
    public void setKeys(com.hp.schemas.SM._7.TmxCatCaoCentralEqpKeysType[] keys) {
        this.keys = keys;
    }

    public com.hp.schemas.SM._7.TmxCatCaoCentralEqpKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.hp.schemas.SM._7.TmxCatCaoCentralEqpKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrievetmxCatCaoCentralEqpKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrievetmxCatCaoCentralEqpKeysListResponse)) return false;
        RetrievetmxCatCaoCentralEqpKeysListResponse other = (RetrievetmxCatCaoCentralEqpKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrievetmxCatCaoCentralEqpKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrievetmxCatCaoCentralEqpKeysListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "tmxCatCaoCentralEqpKeysType"));
