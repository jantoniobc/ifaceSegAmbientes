/**
 * RetrievetmxsfsegsidecciKeysListResponse.java
 *
...
public class RetrievetmxsfsegsidecciKeysListResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.TmxsfsegsidecciKeysType[] keys;
    ...
    public RetrievetmxsfsegsidecciKeysListResponse() {
    }

    public RetrievetmxsfsegsidecciKeysListResponse(
           com.hp.schemas.SM._7.TmxsfsegsidecciKeysType[] keys,
    ...
    /**
     * Gets the keys value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return keys
     */
    public com.hp.schemas.SM._7.TmxsfsegsidecciKeysType[] getKeys() {
        return keys;
    }


    /**
     * Sets the keys value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param keys
     */
    public void setKeys(com.hp.schemas.SM._7.TmxsfsegsidecciKeysType[] keys) {
        this.keys = keys;
    }

    public com.hp.schemas.SM._7.TmxsfsegsidecciKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.hp.schemas.SM._7.TmxsfsegsidecciKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrievetmxsfsegsidecciKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrievetmxsfsegsidecciKeysListResponse)) return false;
        RetrievetmxsfsegsidecciKeysListResponse other = (RetrievetmxsfsegsidecciKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrievetmxsfsegsidecciKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrievetmxsfsegsidecciKeysListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "tmxsfsegsidecciKeysType"));
