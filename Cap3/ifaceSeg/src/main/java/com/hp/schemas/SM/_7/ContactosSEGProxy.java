    ...
    try {
      ...
      if (contactosSEG_PortType != null) {
        if (_endpoint != null)
          ...
          ((javax.xml.rpc.Stub)contactosSEG_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
          ((javax.xml.rpc.Stub)contactosSEG_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
          }
      }
