  ...
  private void _initTmxCatCaoNIRProxy() {
    try {
      ...
      if (tmxCatCaoNIR_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)tmxCatCaoNIR_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
        ((javax.xml.rpc.Stub)tmxCatCaoNIR_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
      }
      }
