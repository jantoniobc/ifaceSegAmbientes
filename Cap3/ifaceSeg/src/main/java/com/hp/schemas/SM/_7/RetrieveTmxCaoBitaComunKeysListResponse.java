/**
 * RetrieveTmxCaoBitaComunKeysListResponse.java
 *
...
public class RetrieveTmxCaoBitaComunKeysListResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.TmxCaoBitaComunKeysType[] keys;
    ...
    public RetrieveTmxCaoBitaComunKeysListResponse() {
    }

    public RetrieveTmxCaoBitaComunKeysListResponse(
           com.hp.schemas.SM._7.TmxCaoBitaComunKeysType[] keys,
    ...
    /**
     * Gets the keys value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return keys
     */
    public com.hp.schemas.SM._7.TmxCaoBitaComunKeysType[] getKeys() {
        return keys;
    }


    /**
     * Sets the keys value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param keys
     */
    public void setKeys(com.hp.schemas.SM._7.TmxCaoBitaComunKeysType[] keys) {
        this.keys = keys;
    }

    public com.hp.schemas.SM._7.TmxCaoBitaComunKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.hp.schemas.SM._7.TmxCaoBitaComunKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveTmxCaoBitaComunKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveTmxCaoBitaComunKeysListResponse)) return false;
        RetrieveTmxCaoBitaComunKeysListResponse other = (RetrieveTmxCaoBitaComunKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveTmxCaoBitaComunKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrieveTmxCaoBitaComunKeysListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "TmxCaoBitaComunKeysType"));
