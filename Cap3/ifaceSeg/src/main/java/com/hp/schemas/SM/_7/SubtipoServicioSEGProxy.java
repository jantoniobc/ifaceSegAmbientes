    ...
    try {
      ...
      if (subtipoServicioSEG_PortType != null) {
        ...
        else
        {
          ...
          ((javax.xml.rpc.Stub)subtipoServicioSEG_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
          ((javax.xml.rpc.Stub)subtipoServicioSEG_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
        }
      }
