/**
 * RetrieveInteraccionSPHistoryListResponse.java
 *
...
public class RetrieveInteraccionSPHistoryListResponse  implements java.io.Serializable {
    ...
    public RetrieveInteraccionSPHistoryListResponse() {
    }
    ...
    /**
     * Gets the instance value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return instance
     */
    ...
    /**
     * Sets the instance value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param instance
     */
    ...
    public com.hp.schemas.SM._7.InteraccionSPHistoryInstanceType getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, com.hp.schemas.SM._7.InteraccionSPHistoryInstanceType _value) {
        this.instance[i] = _value;
    }


    /**
     * Gets the messages value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveInteraccionSPHistoryListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveInteraccionSPHistoryListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveInteraccionSPHistoryListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveInteraccionSPHistoryListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveInteraccionSPHistoryListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveInteraccionSPHistoryListResponse)) return false;
        RetrieveInteraccionSPHistoryListResponse other = (RetrieveInteraccionSPHistoryListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveInteraccionSPHistoryListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrieveInteraccionSPHistoryListResponse"));
