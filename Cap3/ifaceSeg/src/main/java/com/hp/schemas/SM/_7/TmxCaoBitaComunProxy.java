  ...
  private void _initTmxCaoBitaComunProxy() {
    try {
      ...
      if (tmxCaoBitaComun_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)tmxCaoBitaComun_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
        ((javax.xml.rpc.Stub)tmxCaoBitaComun_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
      }
      }
