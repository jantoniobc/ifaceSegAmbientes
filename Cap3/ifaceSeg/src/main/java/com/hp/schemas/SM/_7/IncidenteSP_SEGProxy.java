      ...
      if (incidenteSP_SEG_PortType != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)incidenteSP_SEG_PortType)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
            ...
            ((javax.xml.rpc.Stub)incidenteSP_SEG_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
            ((javax.xml.rpc.Stub)incidenteSP_SEG_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
          }
