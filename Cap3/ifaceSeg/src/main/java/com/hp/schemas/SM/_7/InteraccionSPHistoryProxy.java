  ...
  private void _initInteraccionSPHistoryProxy() {
    try {
      ...
      if (interaccionSPHistory_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)interaccionSPHistory_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
        ((javax.xml.rpc.Stub)interaccionSPHistory_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
      }}
