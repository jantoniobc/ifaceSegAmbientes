  ...
  private void _initInteraccionSPProxy() {
    try {
      ...
      if (interaccionSP_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)interaccionSP_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
        ((javax.xml.rpc.Stub)interaccionSP_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
      }}
