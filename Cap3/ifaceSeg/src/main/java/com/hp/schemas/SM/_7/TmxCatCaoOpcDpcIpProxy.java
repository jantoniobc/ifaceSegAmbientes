      ...
      if (tmxCatCaoOpcDpcIp_PortType != null) {
        if (_endpoint != null)
          ...
          _endpoint = (String)((javax.xml.rpc.Stub)tmxCatCaoOpcDpcIp_PortType)._getProperty("javax.xml.rpc.service.endpoint.address");
	        ((javax.xml.rpc.Stub)tmxCatCaoOpcDpcIp_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
	        ((javax.xml.rpc.Stub)tmxCatCaoOpcDpcIp_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
      }
    }
    }
