  ...
  private void _initGetinfoSidecciEmpresaProxy() {
    try {
      ...
      if (getinfoSidecciEmpresa_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)getinfoSidecciEmpresa_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
        ((javax.xml.rpc.Stub)getinfoSidecciEmpresa_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
      }
      }
    }
