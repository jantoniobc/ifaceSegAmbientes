/**
 * RetrieveIncidenteSP_SEGKeysListResponse.java
 *
...
public class RetrieveIncidenteSP_SEGKeysListResponse  implements java.io.Serializable {
    ...
    public RetrieveIncidenteSP_SEGKeysListResponse() {
    }
    ...
    /**
     * Gets the keys value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return keys
     */
    ...
    /**
     * Sets the keys value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param keys
     */
    ...
    public com.hp.schemas.SM._7.IncidenteSP_SEGKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.hp.schemas.SM._7.IncidenteSP_SEGKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveIncidenteSP_SEGKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveIncidenteSP_SEGKeysListResponse)) return false;
        RetrieveIncidenteSP_SEGKeysListResponse other = (RetrieveIncidenteSP_SEGKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveIncidenteSP_SEGKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrieveIncidenteSP_SEGKeysListResponse"));
