  ...
  private void _initTmxCatCaoCentralEqpProxy() {
    try {
      ...
      if (tmxCatCaoCentralEqp_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)tmxCatCaoCentralEqp_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
        ((javax.xml.rpc.Stub)tmxCatCaoCentralEqp_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
      }
      } 
    }
