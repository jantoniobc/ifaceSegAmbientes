/**
 * RetrievetmxCatCaoNIRListResponse.java
 *
...
public class RetrievetmxCatCaoNIRListResponse  implements java.io.Serializable {
    ...
    public RetrievetmxCatCaoNIRListResponse() {
    }
    ...
    /**
     * Gets the instance value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return instance
     */
    ...
    /**
     * Sets the instance value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param instance
     */
    ...
    public com.hp.schemas.SM._7.TmxCatCaoNIRInstanceType getInstance(int i) {
        return this.instance[i];
    }

    public void setInstance(int i, com.hp.schemas.SM._7.TmxCatCaoNIRInstanceType _value) {
        this.instance[i] = _value;
    }


    /**
     * Gets the messages value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrievetmxCatCaoNIRListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrievetmxCatCaoNIRListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrievetmxCatCaoNIRListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrievetmxCatCaoNIRListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrievetmxCatCaoNIRListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrievetmxCatCaoNIRListResponse)) return false;
        RetrievetmxCatCaoNIRListResponse other = (RetrievetmxCatCaoNIRListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrievetmxCatCaoNIRListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrievetmxCatCaoNIRListResponse"));
