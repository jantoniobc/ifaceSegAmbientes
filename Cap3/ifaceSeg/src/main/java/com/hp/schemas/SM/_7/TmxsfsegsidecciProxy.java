  ...
  private void _initTmxsfsegsidecciProxy() {
    try {
      ...
      if (tmxsfsegsidecci_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)tmxsfsegsidecci_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
        ((javax.xml.rpc.Stub)tmxsfsegsidecci_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
      }
      } 
    }
