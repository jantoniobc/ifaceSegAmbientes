  ...
  private void _initTmxQuejaSmSegProxy() {
    try {
      ...
      if (tmxQuejaSmSeg_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)tmxQuejaSmSeg_PortType)._setProperty(Call.USERNAME_PROPERTY, "blancoja");
        ((javax.xml.rpc.Stub)tmxQuejaSmSeg_PortType)._setProperty(Call.PASSWORD_PROPERTY, "blancojaAdmin");
        }
      }
