  ...
  private void _initTmxCatCaoEmpresaProxy() {
    try {
      ...
      if (tmxCatCaoEmpresa_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)tmxCatCaoEmpresa_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
        ((javax.xml.rpc.Stub)tmxCatCaoEmpresa_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
      }
      }
    }
