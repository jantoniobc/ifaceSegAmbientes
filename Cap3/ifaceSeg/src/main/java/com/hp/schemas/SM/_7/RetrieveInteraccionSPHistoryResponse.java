/**
 * RetrieveInteraccionSPHistoryResponse.java
 *
...
public class RetrieveInteraccionSPHistoryResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.InteraccionSPHistoryModelType model;
    ...
    public RetrieveInteraccionSPHistoryResponse() {
    }

    public RetrieveInteraccionSPHistoryResponse(
           com.hp.schemas.SM._7.InteraccionSPHistoryModelType model,
    ...
    /**
     * Gets the model value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return model
     */
    public com.hp.schemas.SM._7.InteraccionSPHistoryModelType getModel() {
        return model;
    }


    /**
     * Sets the model value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param model
     */
    public void setModel(com.hp.schemas.SM._7.InteraccionSPHistoryModelType model) {
        this.model = model;
    }


    /**
     * Gets the messages value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrieveInteraccionSPHistoryResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrieveInteraccionSPHistoryResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrieveInteraccionSPHistoryResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrieveInteraccionSPHistoryResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrieveInteraccionSPHistoryResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveInteraccionSPHistoryResponse)) return false;
        RetrieveInteraccionSPHistoryResponse other = (RetrieveInteraccionSPHistoryResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveInteraccionSPHistoryResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrieveInteraccionSPHistoryResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "InteraccionSPHistoryModelType"));
