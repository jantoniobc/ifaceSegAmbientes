  ...
  private void _initSegTmxCaseServEmpExtProxy() {
    try {
      ...
      if (segTmxCaseServEmpExt_PortType != null) {
        ...
        ((javax.xml.rpc.Stub)segTmxCaseServEmpExt_PortType)._setProperty(Call.USERNAME_PROPERTY, "ramirezrb");
        ((javax.xml.rpc.Stub)segTmxCaseServEmpExt_PortType)._setProperty(Call.PASSWORD_PROPERTY, "RULO.RAMBEL");
