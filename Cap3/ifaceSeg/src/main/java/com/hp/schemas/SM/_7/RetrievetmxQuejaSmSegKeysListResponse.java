/**
 * RetrievetmxQuejaSmSegKeysListResponse.java
 *
...
public class RetrievetmxQuejaSmSegKeysListResponse  implements java.io.Serializable {
    private com.hp.schemas.SM._7.TmxQuejaSmSegKeysType[] keys;
    ...
    public RetrievetmxQuejaSmSegKeysListResponse() {
    }

    public RetrievetmxQuejaSmSegKeysListResponse(
           com.hp.schemas.SM._7.TmxQuejaSmSegKeysType[] keys,
    ...
    /**
     * Gets the keys value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return keys
     */
    public com.hp.schemas.SM._7.TmxQuejaSmSegKeysType[] getKeys() {
        return keys;
    }


    /**
     * Sets the keys value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param keys
     */
    public void setKeys(com.hp.schemas.SM._7.TmxQuejaSmSegKeysType[] keys) {
        this.keys = keys;
    }

    public com.hp.schemas.SM._7.TmxQuejaSmSegKeysType getKeys(int i) {
        return this.keys[i];
    }

    public void setKeys(int i, com.hp.schemas.SM._7.TmxQuejaSmSegKeysType _value) {
        this.keys[i] = _value;
    }


    /**
     * Gets the messages value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return messages
     */
    ...
    /**
     * Sets the messages value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param messages
     */
    ...
    /**
     * Gets the status value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param status
     */
    ...
    /**
     * Gets the message value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return message
     */
    ...
    /**
     * Sets the message value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param message
     */
    ...
    /**
     * Gets the schemaRevisionDate value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionDate value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
    ...
    /**
     * Gets the schemaRevisionLevel value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
    ...
    /**
     * Sets the schemaRevisionLevel value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
    ...
    /**
     * Gets the returnCode value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return returnCode
     */
    ...
    /**
     * Sets the returnCode value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param returnCode
     */
    ...
    /**
     * Gets the query value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return query
     */
    ...
    /**
     * Sets the query value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param query
     */
    ...
    /**
     * Gets the handle value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return handle
     */
    ...
    /**
     * Sets the handle value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param handle
     */
    ...
    /**
     * Gets the count value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return count
     */
    ...
    /**
     * Sets the count value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param count
     */
    ...
    /**
     * Gets the more value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return more
     */
    ...
    /**
     * Sets the more value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param more
     */
    ...
    /**
     * Gets the start value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @return start
     */
    ...
    /**
     * Sets the start value for this RetrievetmxQuejaSmSegKeysListResponse.
     * 
     * @param start
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrievetmxQuejaSmSegKeysListResponse)) return false;
        RetrievetmxQuejaSmSegKeysListResponse other = (RetrievetmxQuejaSmSegKeysListResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrievetmxQuejaSmSegKeysListResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", ">RetrievetmxQuejaSmSegKeysListResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.hp.com/SM/7", "tmxQuejaSmSegKeysType"));
